...
def OpenFaceArchitecture():
    ...
    inception_3c = concatenate(
        [inception_3c_3x3, inception_3c_5x5, inception_3c_pool], 
        axis=3,
    )
    ...
    inception_4e = concatenate(
        [inception_4e_3x3, inception_4e_5x5, inception_4e_pool], 
        axis=3,
    )
    ...
    inception_5a = concatenate(
        [inception_5a_3x3, inception_5a_pool, inception_5a_1x1], 
        axis=3,
    )
    ...
    inception_5b = concatenate(
        [inception_5b_3x3, inception_5b_pool, inception_5b_1x1], 
        axis=3,
    )
